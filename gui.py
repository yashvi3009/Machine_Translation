...
with open('C:\\Users\\Yashvi\\Downloads\\Machine_Translation\\Machine_Translation-main\\eng_vectorization_config.json') as json_file:
...
with open('C:\\Users\\Yashvi\\Downloads\\Machine_Translation\\Machine_Translation-main\\spa_vectorization_config.json') as json_file:
...
with open('C:\\Users\\Yashvi\\Downloads\\Machine_Translation\\Machine_Translation-main\\eng_vocab.json') as json_file:
    eng_vocab = json.load(json_file)
    eng_vectorization.set_vocabulary(eng_vocab)

# Load and set the Spanish vocabulary
with open('C:\\Users\\Yashvi\\Downloads\\Machine_Translation\\Machine_Translation-main\\spa_vocab.json') as json_file:
    spa_vocab = json.load(json_file)
    spa_vectorization.set_vocabulary(spa_vocab)


# load the spanish model
transformer = load_model('C:\\Users\\Yashvi\\Downloads\\Machine_Translation\\Machine_Translation-main\\transformer_model')
...
#load  French model
model = load_model('C:\\Users\\Yashvi\\Downloads\\Machine_Translation\\Machine_Translation-main\\english_to_french_model')

#load Tokenizer
with open('C:\\Users\\Yashvi\\Downloads\\Machine_Translation\\Machine_Translation-main\\english_tokenizer.json') as f:
    data = json.load(f)
    english_tokenizer = tokenizer_from_json(data)
    
with open('C:\\Users\\Yashvi\\Downloads\\Machine_Translation\\Machine_Translation-main\\french_tokenizer.json') as f:
    data = json.load(f)
    french_tokenizer = tokenizer_from_json(data)
    

#load max length
with open('C:\\Users\\Yashvi\\Downloads\\Machine_Translation\\Machine_Translation-main\\sequence_length.json') as f:
